        ...
        <a id="projects"    >
            <section className="projects">
                ...
                <div className="projects-div">
                    ...
                    <ProjectEntry title="Annotation Generation" description="An easy way to generate data files using annotations while modding." language="Java" image={annotation_icon} github={"https://github.com/AG6Dev/AnnotationGeneration"}/>
                </div>
            </section>
        </a>
    )
